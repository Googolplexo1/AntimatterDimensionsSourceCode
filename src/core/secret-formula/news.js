...
export const news = [
  ...
  },
  {
    ...
    get text() {
      ...
      return `Внимание: указ ${lawID}-B, составленный ИИ Duskscarf, также известный как закон "О гигантских
  ...
  },
  {
    ...
    get text() {
      const chapters = [
        ...
        и Париж вызывает у людей со всех уголков света любопытство и восхищение.`,
  ...
  },
  {
    ...
    text:
      ...
      хотите ли вы нажать на кнопку и добровольно погрузиться в глубины отчаяния? Надеюсь, нет, потому что она здесь отсутствует.`
  },
  {
    id: "a369",
    text:
  ...
  },
  {
    ...
    text: 
      ...
      Это явно не лучшая стадия игры. - Этот человек немедленно отбросил бы ваш телефон и начал играть в ИА.`,
    get unlocked() { return PlayerProgress.realityUnlocked() || PlayerProgress.dilationUnlocked(); }
  },
  {
    id: "l77",
  ...
  },
  {
    ...
    text:
      ...
      банках и нанооболочках, для применения которых требуются обширные исследования и разработки. По существу, сообщать о незаконном получении антиматерии
