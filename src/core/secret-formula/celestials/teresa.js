export const teresa = {
  unlocks: {
    ...
    epGen: {
      id: 1,
      price: 1e18,
      description: () => `Ежесекундно вы получаете ${formatPercents(0.01)} от максимального прироста Очков Вечности за минуту реального времени, который вам могла бы дать текущая вечность.`,
