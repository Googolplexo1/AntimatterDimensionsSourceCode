...
export const normalChallenges = [
  ...
  },
  {
    ...
    isQuickResettable: false,
    description:
      `вы получаете множитель к производству антиматерии, который изначально мал, зато неограниченно экспоненциально возрастает,
  ...
  },
  {
    ...
    legacyId: 11,
    isQuickResettable: false,
    description: `Галактики Антиматерии недоступны. Вы можете получить не более пяти Расширений Измерений, и они не дают
