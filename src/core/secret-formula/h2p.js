...
очень долго не были в игре и у вас низкое количество офлайн-тиков, вы можете потерять часть положенного вам прогресса
за время отсутствия.
<br>
<br>
...
<br>
<br>
<b>Скорость тика:</b> фактически это особый множитель к производству всех Измерений Антиматерии. Она не учтиывается в
...
<br>
<br>
<b>Интервал</b> - это время, которое должно пройти между двумя совершениями автоматики её действия.
<br>
<br>
...
<br>
<br>
<b>Горячая клавиша A</b> приостанавливает или возобновляет всю автоматику. Кроме того, одновременное зажаттие клавиши
...
<br>
<br>
<b>Горяачя клавиша E</b> совершает вечность.
`,
...
дальнейшем, пока не выполните это испытание. В частности, вторичное требования испытания и само испытание можно
...
<br>
<br>
Чёрная Дыра особым образом взаимодействуют с офлайн-прогрессом, см. статью "Офлайн-прогресс".
<br>
<br>
...
её эффект аннулируется и линейно восстаналивается в течение ${BlackHoles.ACCELERATION_TIME} секунд по реальному времяисчислению.
...
и ускоритель имеет значение континуума, которое зависят примерно равно количеству покупок, стоящих не больше, чем текущее
...
изменяется в ${formatInt(11)} раз в соответствующую сторону, что повышает среднюю скорость получения Сингулярностей.
<br>
<br>
...
Даёт <i>Останки</i> в зависимости от рекордного количества антиматерии, Очков Бесконечности и Очков Вечности, которые
производят <i>Осколки Реальности</i> по реальному времяисчислению. Останки, аналогично Тахионам, не накапливаются.
<br>
<br>
