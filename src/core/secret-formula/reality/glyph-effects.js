...
export const glyphEffects = {
  ...
  replicationdtgain: {
    ...
    singleDesc: () => (GlyphAlteration.isAdded("replication")
      ? `Множитель к производству Замедленного Времени [и скорости репликации] в зависимости от количества Репликанти ({value}×log_${format(Decimal.pow(10, 10000))}_(x), но при наложении нескольких таких эффектов логарифм учитывается только один раз)`
      : `Множитель к производству Замедленного Времени в зависимости от количества Репликанти ({value}×log_${format(Decimal.pow(10, 10000))}_(x), но при наложении нескольких таких эффектов логарифм учитывается только один раз)`),
  ...
  infinityrate: {
    ...
    shortDesc: "+{value} к степени эффекта Силы Бесконечности",
  ...
  cursedtickspeed: {
    ...
    totalDesc: () => `Множитель ×{value} к значению, на которое наценка на ускорители, получаемые от Осколков Времени, превышает ${formatInt(1)}`,
  ...
  realityglyphlevel: {
    ...
    isGenerated: false,
    glyphTypes: ["reality"],
    singleDesc: "Увеличить фактические уровни действующих глифов основных типов на {value}",
    shortDesc: "+{value} к уровням действующих глифов основных типов",
