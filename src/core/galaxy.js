...
export class Galaxy {
  ...
  static get lockText() {
    ...
    if (EternityChallenge(6).isRunning) return "Недоступно (6-е Испытание Вечности)";
    if (InfinityChallenge(7).isRunning) return "Недоступно (7-е Испытание Бесконечности)";
