...
<template>
  <div>
    ...
    Подробности по определённой функциональности могут быть найдены на соответствующих страницах Автоматизатора.
    <br>
    <br>
    ...
    Нажмите на кнопку <div class="fas fa-list c-automator-button-icon" /> для просмотра списка доступных команд. Вы также можете
    ...
    <br>
    <br>
    <b>Отладка:</b> Два главных инструмента, данных вам для отладки ваших программ, - это журнал ошибок
    ...
    <br>
    <br>
    <b>Хранение программ:</b> обратите внимание, что изменения к программам сохраняются на ваш компьютер не сразу,
    а периодически - вместе со всеми остальными данными игры. Кроме того, есть два ограничения на количество символов в программах,
