  ...
  <ModalWrapper>
    ...
    <div class="c-enslaved-hint-modal c-modal--short">
      ...
      <div v-if="realityHintsLeft + glyphHintsLeft > 0">
        Вы можете тратить время на открытие каких-нибудь ещё трещин в этой Реальности, но каждый раз, когда вы тратите сохранённое игровое время
        на подсказку, необходимое количество сохранённого игрового времени увеличивается в {{ formatInt(3) }} раза. Это увеличение цены
        ...
        <br><br>
        Следующая подсказка стоит {{ hintCost }} сохранённого игрового времени. Сейчас у вас {{ formattedStored }}.
